exports.seed = async function (knex) {
  ...
  await knex("items").insert([
    ...
    { id: 5, user_id: 6, title: "Rare Stamp", description: "A valuable stamp", min_price: 250.0, category_id: 5, end_time: "2025-03-02 00:00:00", authentication_status: 'Pending', auction_status: 'Not Listed' },
    { id: 6, user_id: 5, title: "Vintage Typewriter", description: "An old typewriter", min_price: 300.0, category_id: 6, end_time: "2025-03-01 03:00:00", authentication_status: 'Pending', auction_status: 'Not Listed' },
    { id: 7, user_id: 7, title: "Rare Book", description: "A valuable book", min_price: 350.0, category_id: 11, end_time: "2025-03-27 06:00:00", authentication_status: 'Not Requested', auction_status: 'Active' }
  ]);
  ...
  await knex("authentication_requests").insert([
    ...
    { id: 2, user_id: 4, item_id: 2, status: "Pending", expert_id: null, second_opinion_requested: false, new_expert_id: null, comments: "Looks good!", decision_timestamp: "2025-02-25 12:00:00" },
    ...
    { id: 4, user_id: 4, item_id: 4, status: "Pending", expert_id: null, second_opinion_requested: false, new_expert_id: null, comments: "Looks good!", decision_timestamp: "2025-02-25 12:00:00" },
